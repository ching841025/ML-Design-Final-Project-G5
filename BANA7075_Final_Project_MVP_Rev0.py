...
# Make a directory for the MLFlow Experiments
model_dir = "mlruns/experiments"
os.makedirs(model_dir, exist_ok=True)

# Set file location for MLFlow expierments
mlflow.set_tracking_uri("mlruns/experiments")

# Name the ML FLow expierment
...
# Start the MLFlow Model Logging run.
with mlflow.start_run(run_name="Model Training") as run:
    ...
    for sym in symbols:
        ...
        # Select an input example from your training data
        ...
        # Log parameters and metrics with a unique prefix for each symbol
        ...
        print(f"{sym} | R2: {r2:.4f} | MSE: {mse:.4f}")
