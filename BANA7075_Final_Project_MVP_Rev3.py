...
symbols_to_keep = symbol_counts[symbol_counts > 1790].index
...
for lag in range(1, 16):
    data_count[f"RET_lag{lag}"] = data_count.groupby("symbol")["RET"].shift(lag)
    
data_count = data_count.dropna()

data_count.to_csv('stock_data_120_rev3.csv', index=False)
...
# run in bash mlflow ui --backend-store-uri "file:///C:/Alpaca/mlruns"
mlflow.set_tracking_uri("http://127.0.0.1:5000")
mlflow.set_experiment("20240419_EXP2")
...
# Log input dataset
dataset_name = "stock_data_120_rev3"
dataset_source = "C:\Alpaca\ML_Design_Project"  # raw string not needed, no backslashes
...
# Feature list
features = ["RET_mean", "RET_std", "RET_skew", "RET_kurt", "RET_rf", "vwap", "RET_SPY","RET_lag1", "RET_lag2", "RET_lag3",	
"RET_lag4",	"RET_lag5",	"RET_lag6","RET_lag7","RET_lag8","RET_lag9","RET_lag10","RET_lag11","RET_lag12",	
"RET_lag13","RET_lag14","RET_lag15"]
...
client = MlflowClient()
experiment = client.get_experiment_by_name("20240419_EXP2")
